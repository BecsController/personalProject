  ...
  return knex('pages').del()
    .then(function () {
      ...
      return knex('pages').insert([
        ...
        {id: 3, title: 'Getting Ready', background: '/images/backgrounds/house.jpeg', population: '/images/parents.jpeg', emotionOne: 'I am feeling Anxious', emotionTwo: 'I am feeling Excited', emotionThree: 'I am feeling Scared', pageText: "You have been left alone in your room.  Now what will you do?", optionOne: 'Reply, "Get dressed and ready"', optionTwo: 'Reply, "I don\'t want to get ready yet"', story_id: 1},
        {id: 4, title: 'The Classroom', background: '/images/backgrounds/inside-a-kindergarten-classroom-background.jpg', population: '/images/teacher.jpeg', emotionOne: 'I am feeling Anxious', emotionTwo: 'I am feeling Excited', emotionThree: 'I am feeling Scared', pageText: 'In the classroom, your teacher comes over to introduce herself. \n Hi, I\'m Miss Davis, what\'s your name? \n She holds out her hand.', optionOne: 'Reply, "Turn away, I don\’t want to shake hands"', optionTwo: 'Reply, "I don\’t like to be touched, but nice to meet you"', story_id: 1}
      ]);
    });
};
